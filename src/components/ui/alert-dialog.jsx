...
const AlertDialogFooter = ({
  ...
  <div
    className={cn("flex flex-row justify-center align-center gap-6", className)}
    {...props} />
)
...
const AlertDialogCancel = React.forwardRef(({ className,variant,size, ...props }, ref) => (
