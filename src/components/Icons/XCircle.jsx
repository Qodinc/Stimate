const XCircle = ({ fill = 'none', stroke = 'black', width, height }) => (
   <svg width={width} height={height} viewBox="0 0 24 24" fill={fill} xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M15 9L9 15" stroke={stroke} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M9 9L15 15" stroke={stroke} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
   </svg>
);
