        ...
        <div className="w-full overflow-x-auto md:overflow-hidden">
            ...
            <tbody>
                <tr className="text-baseColor">
                    ...
                    <td className="p-2">{formatPrice(developmentCost)}</td>
                </tr>
                {associatedCosts.map((cost) => {
                    ...
                    <tr key={cost._id} className="text-baseColor">
                        ...
                        <td className="p-2">{formatPrice(cost.price_unity)}</td>
                        <td className="p-2">{formatPrice(cost.price_unity * cost.quantity)}</td>
                    </tr>
                    );
                })}
            </tbody>
